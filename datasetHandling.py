...
def measure():
    #record = '1,85,66,29,0,26.6,0.351,31,0'
    start_time = timeit.default_timer()
    datasetHandler.functions.readRecord(2).call()
    print('time for writeRecord is: ', timeit.default_timer() - start_time)
...
def measureWhole():
    ...
    init = 2
    start_time = timeit.default_timer()
    loadDataset(init,latest_id)
    print('time for loadDataset Procedure: ', timeit.default_timer() - start_time)